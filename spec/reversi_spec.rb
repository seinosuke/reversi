...
describe Reversi do
  ...
  describe "石を置く前" do
    it do
      expect(@game.player_w.next_moves).to eq [[3, 5], [4, 6], [5, 3], [6, 4], [7, 5], [7, 7]]
      expect(@game.player_w.count_disks).to eq 3
      expect(@game.player_b.count_disks).to eq 7
    end
  end
  ...
  describe "石を置いた後" do
    it do
      ...
      expect(@game.player_w.next_moves).to eq [[3, 5], [3, 6], [4, 6], [6, 2], [7, 2], [8, 3]]
      expect(@game.player_w.count_disks).to eq 7
      expect(@game.player_b.count_disks).to eq 4
    end
  end
end
...
describe Reversi do
  ...
  describe "石を置いた後" do
    it do
      @game.player_b.put_disk(4, 2)
      expect(@game.player_w.count_disks).to eq 2
      expect(@game.player_b.count_disks).to eq 5
    end
  end
end
